...
\title[QEMU/KVM Prerequisite]{QEMU/KVM Prerequisite} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\column{.7\textwidth}
\begin{itemize}
\visible<1->{\item take home1}
\visible<2->{\item take home2}
\visible<3->{\item take home3}
\visible<4->{\item take home4}
\end{itemize}
\column{.3\textwidth}
\begin{center}
\begin{figure}
